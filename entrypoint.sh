...
# Validate CLUSTER_SIZE to prevent path traversal
case "$INPUT_CLUSTER_SIZE" in
  dev|test) ;;
  *) echo "ERROR: Invalid CLUSTER_SIZE '${INPUT_CLUSTER_SIZE}'. Must be 'dev' or 'test'." >&2; exit 1 ;;
esac
